...
<div class="container">
<h2>Actualizar persona contemporanea por id </h2>
<form  class="form-horizontal" action="/WebCliente/ActCont" method="Post">
<input type="hidden" value="actualizar" name="rutear">
